package com.hau.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.hau.springboot.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[]{"com.hau.springboot.model"});
